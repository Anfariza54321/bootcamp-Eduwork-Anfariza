<x-app-layout>
    <div x-data="{ openEdit: false, editId: '', editNama: '' }" class="bg-black min-h-screen">
        ...
        <x-slot name="header">
            <h2 class="font-black text-xl text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 uppercase italic tracking-[0.2em]">
                {{ __('Database') }}
            </h2>
        </x-slot>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-gray-900/50 backdrop-blur-xl border border-cyan-500/20 shadow-[0_0_30px_rgba(6,182,212,0.1)] overflow-hidden sm:rounded-2xl">
                    <div class="p-8">
                        
                        <div class="flex justify-between items-center mb-8">
                            <div>
                                <h2 class="text-2xl font-black text-white uppercase tracking-tighter">Brand <span class="text-purple-400">Assets</span></h2>
                            ...
                            <a href="{{ route('merek.create') }}" 
                                ...
                                <span class="relative z-10 text-purple-400 group-hover:text-black font-bold uppercase text-sm transition-colors duration-300">+ New_Brand</span>
                                <div class="absolute inset-0 bg-purple-500 translate-x-[-101%] group-hover:translate-x-0 transition-transform duration-300"></div>
                            </a>
                        </div>
                            ...
                            <table class="min-w-full border-separate border-spacing-y-3">
                                ...
                                <tbody>
                                    @foreach ($mereks as $merek)
                                        <tr class="group bg-gray-800/40 hover:bg-cyan-500/10 border border-transparent hover:border-cyan-500/50 transition-all duration-300">
                                            <td class="py-4 px-4 rounded-l-xl border-y border-l border-white/5 font-mono text-xs text-gray-500 group-hover:text-cyan-400">
                                                [{{ str_pad($loop->iteration, 2, '0', STR_PAD_LEFT) }}]
                                            </td>
                                            
                                            <td class="py-4 px-4 border-y border-white/5">
                                                <span class="text-sm font-bold text-white uppercase tracking-wider group-hover:text-purple-400 transition-colors">
                                                    {{ $merek->nama }}
                                                </span>
                                            </td>

                                            <td class="py-4 px-4 border-y border-white/5 text-center">
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase bg-cyan-500/10 border border-cyan-500/50 text-cyan-400 shadow-[0_0_10px_rgba(6,182,212,0.2)]">
                                                ...
                                                <div class="flex justify-center gap-3">
                                                    ...
                                                    <form action="{{ route('merek.destroy', $merek->id) }}" method="POST">
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            onclick="return confirm('Initiate data deletion protocol?')">
        ...
        <div x-show="openEdit" 
            ...
            <div class="relative bg-gray-900 border border-purple-500/50 rounded-2xl shadow-[0_0_50px_rgba(168,85,247,0.2)] max-w-md w-full p-8 overflow-hidden">
                ...
                <h2 class="text-xl font-black text-white uppercase italic tracking-tighter mb-6 border-l-4 border-purple-500 pl-4">
                ...
                <form :action="'{{ url('merekAdmin') }}/' + editId" method="POST">
                    ...
                    <div class="mb-8 group">
                        <label class="block text-[10px] uppercase tracking-[0.3em] font-black text-purple-500 mb-2">Identify_Label</label>
